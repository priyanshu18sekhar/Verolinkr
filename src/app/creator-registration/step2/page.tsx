...
export default function CreatorRegistrationStep2() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (otpString.length === 6) {
        router.push('/creator-registration/step3');
      } else {
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-100 py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        >
              ...
              <div className="flex justify-center space-x-3">
                {otp.map((digit, index) => (
                  <input
                    ...
                    className={`w-12 h-12 text-center text-xl font-semibold border-2 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 ${
          ...
          <div className="mt-6 text-center">
            <Link
              href="/creator-registration/step1"
