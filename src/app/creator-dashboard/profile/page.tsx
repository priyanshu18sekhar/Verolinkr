          ...
          <div className="flex justify-between items-start py-8">
            <div className="flex-1">
              ...
              <p className="text-[14px] text-gray-600 font-normal max-w-lg">
                Manage your profile information and showcase your work to brands
              </p>
            </div>
            <motion.button
              className={`px-6 py-3 rounded-full text-[13px] font-bold transition-all duration-200 ${
                isEditing 
                  ? 'bg-black text-white hover:bg-gray-900 premium-glow-button' 
        ...
        >
          <div className="flex flex-col lg:flex-row items-center lg:items-start space-y-6 lg:space-y-0 lg:space-x-8">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-[14px] text-gray-700 leading-relaxed max-w-2xl mx-auto lg:mx-0">
          ...
          <div className="p-8">
            ...
            {activeTab === 'personal' && (
              <div className="space-y-8">
                ...
                {/* Social Media Links */}
                <div>
                  <label className="block text-[11px] font-bold text-gray-600 mb-4 uppercase tracking-wider">Social Media Links</label>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="border border-gray-200 rounded-lg p-4 hover:border-black transition-all duration-200">
                      <div className="flex items-center gap-3 mb-2">
                        <div className="w-8 h-8 bg-black rounded-lg flex items-center justify-center">
                          <span className="text-white font-bold text-[11px]">IG</span>
                        </div>
                        <span className="text-[12px] font-bold text-gray-600">Instagram</span>
                      </div>
                      <input
                        type="text"
                        ...
                        disabled={!isEditing}
                        className="w-full px-3 py-2 rounded border border-gray-200 focus:border-black focus:ring-1 focus:ring-black text-[13px] font-medium text-black disabled:bg-gray-50 disabled:cursor-not-allowed transition-all duration-200"
                      />
                    </div>
                    <div className="border border-gray-200 rounded-lg p-4 hover:border-black transition-all duration-200">
                      <div className="flex items-center gap-3 mb-2">
                        <div className="w-8 h-8 bg-black rounded-lg flex items-center justify-center">
                          <span className="text-white font-bold text-[11px]">YT</span>
                        </div>
                        <span className="text-[12px] font-bold text-gray-600">YouTube</span>
                      </div>
                      <input
                        type="text"
                    ...
                    <div className="border border-gray-200 rounded-lg p-4 hover:border-black transition-all duration-200">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-[12px] font-bold text-gray-600">Twitter</span>
                      </div>
                      <input
                        type="text"
                        placeholder="@username"
                    ...
                    {profileData.professional.achievements.map((achievement, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <h5 className="text-[16px] font-black text-black mb-2 text-center">{achievement.title}</h5>
                          <p className="text-[13px] text-gray-600 text-center">{achievement.description}</p>
                        </motion.div>
                      );
                    })}
                  </div>
